            ...
            <div class="mesgs">
                            ...
                            <div class="incoming_msg">
                                ...
                                <div class="received_msg">
                                    <div class="received_withd_msg">
                                        <p>{{ $message->message }}</p>
                                        <span class="time_date">{{ $message->sentAt }}</span>
                                    </div>
                                </div>
                            </div>
                        @else
                ...
                <div class="type_msg">
                    <div class="input_msg_write">
                        <form action="/admin/addMessage/{{$messageEnt->id}}" method="post">
                            @csrf
                            <input name="message" type="text" class="write_msg" placeholder="Type a message" />

                        </form>
                        <button class="msg_send_btn" type="submit"><i class="far fa-paper-plane"></i></button>
                    </div>
                </div>
            </div>
        </div>
